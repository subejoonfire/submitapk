                ...
                <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                    ...
                    <ul class="list-reset flex flex-col">
                        ...
                        <li class="w-full h-full py-3 px-2">
                            <a href="#" class="pages-dropdown font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                                <i class="far fa-file float-left mx-2"></i>
                                Pages
                                <span><i class="fa fa-angle-down float-right transition-transform"></i></span>
                            </a>
                            <ul class="submenu list-reset -mx-2 bg-white-medium-dark hidden">
                        ...
                        <style>
                            /* CSS untuk animasi dan transisi */
                            .submenu {
